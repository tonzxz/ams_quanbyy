...
export class NtpComponent {
  mockData = {
    ...
    recipient: {
      ...
      address: 'Landco Business Park, Legazpi City',
    ...
    content.innerHTML = `
      <div class="p-10 ml-10 bg-white shadow-md" style="width: 360mm; min-height: 350mm; font-family: Arial, sans-serif;">
        ...
        <div class="mb-6 text-2xl">
          <p class="">Dear <strong>MS. MAXWELL:</strong></p>
        ...
        <div class="mb-6 text-2xl">
          <p class="">The delivery and acceptance are within <strong>${this.mockData.deliveryInstructions.lot1} ${this.mockData.deliveryInstructions.lot5}</stong></p>
