...
DROP TABLE IF EXISTS procurement_modes CASCADE;
...
DROP TABLE IF EXISTS ppmp_approvers CASCADE;
DROP TABLE IF EXISTS app CASCADE;
DROP TABLE IF EXISTS app_approvers CASCADE;
DROP TABLE IF EXISTS purchase_requests CASCADE;
DROP TABLE IF EXISTS purchase_request_approvers CASCADE;
DROP TABLE IF EXISTS procurement_process CASCADE;
DROP TABLE IF EXISTS contracts CASCADE;
DROP TABLE IF EXISTS inspection_acceptance CASCADE;
